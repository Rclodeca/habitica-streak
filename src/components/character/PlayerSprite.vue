...
// Composited player sprite: a fixed base (skin + hair) with up to 3 gear
// layers stacked on top, driven by whichever items are currently equipped.
// All layer PNGs share the same 90x90 canvas/pose (verified against the
// HabitRPG/habitica-images source — see CREDITS.md), so plain absolute
// positioning at inset:0 is enough; no per-layer offset data is needed.
